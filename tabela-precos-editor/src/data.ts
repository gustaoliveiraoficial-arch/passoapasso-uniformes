...
export const paymentData = [
  { method: "PIX", rules: "Sem acréscimo. 50% na aprovação + 50% na entrega. Pagamento integral à vista: 5% de desconto." },
  { method: "DINHEIRO", rules: "À vista. Sem nota fiscal: 7% de desconto." },
  { method: "CARTÃO DE CRÉDITO", rules: "Débito: sem acréscimo. 1x: +3%. Até 3x: +6%." },
  { method: "LINK DE PAGAMENTO", rules: "Até 3x: +12%. Acima de 3x: consultar." }
]
...
export const defaultData: Category[] = [
  {
    ...
    description: "Incluso: 1 estampa em serigrafia de até 2 cores. Peças acima do GG: +30% sobre o valor unitário.",
    items: [
      {
        id: "c-pv-premium",
        name: "PV Premium",
  ...
  },
  {
    ...
    description: "Piquet PV: incluso 1 bordado lado esquerdo | Poliviscose/Dry Liso: 2 estampas serigrafia 2 cores. Manga Longa: +R$22. Infantil até 14 anos: -R$5.",
    items: [
      {
        id: "p-piquet-pv",
        name: "Piquet PV",
      ...
      },
      {
        ...
        name: "Poliviscose",
        colors: "Preto, Branco, Az. Marinho, Cinza Mescla Claro/Escuro",
        obs: "Incluso 1 bordado até 9cm — não cobrar adicional de bordado",
        tiers: [
  ...
  },
  {
    ...
    description: "Infantil até 14 anos. Incluso: 1 Bordado P. Manga Longa: +R$12. Acréscimos iguais ao Polo.",
    items: [
      {
        id: "mb-piquet-pv",
  ...
  },
  {
    ...
    description: "Acréscimos aplicados sobre o valor base de cada peça. Matriz de bordado é cobrada uma única vez por arte.",
    items: [
      {
        id: "p-serigrafia-logo-extra",
        name: "Logo extra serigrafia — até 2 cores / 28 cm",
        colors: "",
        tiers: [{ qty: "Valor", price: "+ R$ 6,00" }]
      },
      {
        id: "p-serigrafia-cor-adicional",
        name: "Cor adicional serigrafia (por cor)",
        colors: "",
        tiers: [{ qty: "Valor", price: "+ R$ 1,50" }]
      },
      {
        id: "p-serigrafia-nome",
        name: "Nome — serigrafia",
        colors: "",
        tiers: [{ qty: "Valor", price: "+ R$ 10,00" }]
      },
      {
        id: "p-serigrafia-numeracao",
        name: "Numeração — serigrafia",
        colors: "",
        tiers: [{ qty: "Valor", price: "+ R$ 12,00" }]
      },
      {
        id: "p-serigrafia-plastisol",
        name: "Estampa Plastisol",
        colors: "",
        tiers: [{ qty: "Valor", price: "+ R$ 6,00" }]
      },
      {
        id: "p-dtf-pequeno",
        name: "DTF — Pequeno (até 10 cm)",
        colors: "",
        tiers: [{ qty: "Valor", price: "Consultar" }]
      },
      {
        id: "p-dtf-medio",
        name: "DTF — Médio (até 20 cm)",
        colors: "",
        tiers: [{ qty: "Valor", price: "Consultar" }]
      },
      {
        id: "p-dtf-grande",
        name: "DTF — Grande (acima de 20 cm)",
        colors: "",
        tiers: [{ qty: "Valor", price: "Consultar" }]
      },
      {
        ...
        colors: "Cobrada uma única vez por arte/logomarca",
        tiers: [{ qty: "Valor", price: 45.00 }]
      },
      {
        id: "p-bordado-p",
        name: "Bordado P — até 5 cm",
        colors: "",
        tiers: [{ qty: "Valor", price: "+ R$ 7,00" }]
      },
      {
        id: "p-bordado-m",
        name: "Bordado M — até 9 cm",
        colors: "",
        tiers: [{ qty: "Valor", price: "+ R$ 12,00" }]
      },
      {
        id: "p-gola-personalizada",
        name: "Gola personalizada",
        colors: "",
        tiers: [{ qty: "Valor", price: "+ R$ 10,00" }]
      },
      {
