"use strict";exports.id=814,exports.ids=[814],exports.modules={2881:(e,t,r)=>{r.d(t,{Z:()=>l});var n=r(7577);/**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(0,n.KN)("firebase","10.14.1","app")},5449:(e,t,r)=>{r.d(t,{ET:()=>rk,hJ:()=>tM,oe:()=>rV,JU:()=>tB,QT:()=>rN,PL:()=>rS,ad:()=>tF,Xo:()=>rg,IO:()=>rd,r7:()=>rD});var n,i=r(3497),s=r(7752),a=r(5036),o=r(3837),l=r(2377),u=r(3122),c=r(6113);let h="4.7.3";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class C{constructor(e,t,r,n,i,s,a,o,l){this.databaseId=e,this.appId=t,this.persistenceKey=r,this.host=n,this.ssl=i,this.forceLongPolling=s,this.autoDetectLongPolling=a,this.longPollingOptions=o,this.useFetchStreams=l}}let R="(default)";class L{constructor(e,t){this.projectId=e,this.database=t||R}static empty(){return new L("","")}get isDefaultDatabase(){return this.database===R}isEqual(e){return e instanceof L&&e.projectId===this.projectId&&e.database===this.database}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class M{constructor(e){this.path=e}static fromPath(e){return new M(P.fromString(e))}static fromName(e){return new M(P.fromString(e).popFirst(5))}static empty(){return new M(P.emptyPath())}get collectionGroup(){return this.path.popLast().lastSegment()}hasCollectionId(e){return this.path.length>=2&&this.path.get(this.path.length-2)===e}getCollectionGroup(){return this.path.get(this.path.length-2)}getCollectionPath(){return this.path.popLast()}isEqual(e){return null!==e&&0===P.comparator(this.path,e.path)}toString(){return this.path.toString()}static comparator(e,t){return P.comparator(e.path,t.path)}static isDocumentKey(e){return e.length%2==0}static fromSegments(e){return new M(new P(e.slice()))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class eC{}class eR extends eC{constructor(e,t,r){super(),this.field=e,this.op=t,this.value=r}static create(e,t,r){return e.isKeyField()?"in"===t||"not-in"===t?this.createKeyFieldInFilter(e,t,r):new eO(e,t,r):"array-contains"===t?new eU(e,r):"in"===t?new eM(e,r):"not-in"===t?new eB(e,r):"array-contains-any"===t?new e$(e,r):new eR(e,t,r)}static createKeyFieldInFilter(e,t,r){return"in"===t?new eF(e,r):new eP(e,r)}matches(e){let t=e.data.field(this.field);return"!="===this.op?null!==t&&this.matchesComparison(ew(t,this.value)):null!==t&&ey(this.value)===ey(t)&&this.matchesComparison(ew(t,this.value))}matchesComparison(e){switch(this.op){case"<":return e<0;case"<=":return e<=0;case"==":return 0===e;case"!=":return 0!==e;case">":return e>0;case">=":return e>=0;default:return _()}}isInequality(){return["<","<=",">",">=","!=","not-in"].indexOf(this.op)>=0}getFlattenedFilters(){return[this]}getFilters(){return[this]}}class eL extends eC{constructor(e,t){super(),this.filters=e,this.op=t,this.memoizedFlattenedFilters=null}static create(e,t){return new eL(e,t)}matches(e){return"and"===this.op?void 0===this.filters.find(t=>!t.matches(e)):void 0!==this.filters.find(t=>t.matches(e))}getFlattenedFilters(){return null!==this.memoizedFlattenedFilters||(this.memoizedFlattenedFilters=this.filters.reduce((e,t)=>e.concat(t.getFlattenedFilters()),[])),this.memoizedFlattenedFilters}getFilters(){return Object.assign([],this.filters)}}class eO extends eR{constructor(e,t,r){super(e,t,r),this.key=M.fromName(r.referenceValue)}matches(e){let t=M.comparator(e.key,this.key);return this.matchesComparison(t)}}class eF extends eR{constructor(e,t){super(e,"in",t),this.keys=ex("in",t)}matches(e){return this.keys.some(t=>t.isEqual(e.key))}}class eP extends eR{constructor(e,t){super(e,"not-in",t),this.keys=ex("not-in",t)}matches(e){return!this.keys.some(t=>t.isEqual(e.key))}}function ex(e,t){var r;return((null===(r=t.arrayValue)||void 0===r?void 0:r.values)||[]).map(e=>M.fromName(e.referenceValue))}class eU extends eR{constructor(e,t){super(e,"array-contains",t)}matches(e){let t=e.data.field(this.field);return eT(t)&&e_(t.arrayValue,this.value)}}class eM extends eR{constructor(e,t){super(e,"in",t)}matches(e){let t=e.data.field(this.field);return null!==t&&e_(this.value.arrayValue,t)}}class eB extends eR{constructor(e,t){super(e,"not-in",t)}matches(e){if(e_(this.value.arrayValue,{nullValue:"NULL_VALUE"}))return!1;let t=e.data.field(this.field);return null!==t&&!e_(this.value.arrayValue,t)}}class e$ extends eR{constructor(e,t){super(e,"array-contains-any",t)}matches(e){let t=e.data.field(this.field);return!!eT(t)&&!!t.arrayValue.values&&t.arrayValue.values.some(e=>e_(this.value.arrayValue,e))}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class e8{constructor(){this._=void 0}}class e7 extends e8{}class te extends e8{constructor(e){super(),this.elements=e}}class tt extends e8{constructor(e){super(),this.elements=e}}class tr extends e8{constructor(e,t){super(),this.serializer=e,this.operand=t}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let tV="ComponentProvider",tk=new Map;function tC(e){if(e._terminated)throw new E(w.FAILED_PRECONDITION,"The client has already been terminated.");if(!tk.has(e)){var t,r,n;m(tV,"Initializing Datastore");let i=new J((t=e._databaseId,r=e.app.options.appId||"",new C(t,r,e._persistenceKey,(n=e._freezeSettings()).host,n.ssl,n.experimentalForceLongPolling,n.experimentalAutoDetectLongPolling,G(n.experimentalLongPollingOptions),n.useFetchStreams)),u.fetch),s=tI(e._databaseId),a=new tA(e._authCredentials,e._appCheckCredentials,i,s);tk.set(e,a)}return tk.get(e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class tP{constructor(e,t,r){this.converter=t,this._query=r,this.type="query",this.firestore=e}withConverter(e){return new tP(this.firestore,e,this._query)}}class tx{constructor(e,t,r){this.converter=t,this._key=r,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new tU(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new tx(this.firestore,e,this._key)}}class tU extends tP{constructor(e,t,r){super(e,t,new e1(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){let e=this._path.popLast();return e.isEmpty()?null:new tx(this.firestore,null,new M(e))}withConverter(e){return new tU(this.firestore,e,this._path)}}function tM(e,t,...r){if(e=(0,l.m9)(e),B("collection","path",t),e instanceof tO){let n=P.fromString(t,...r);return q(n),new tU(e,null,n)}{if(!(e instanceof tx)&&!(e instanceof tU))throw new E(w.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");let n=e._path.child(P.fromString(t,...r));return q(n),new tU(e.firestore,null,n)}}function tB(e,t,...r){if(e=(0,l.m9)(e),1==arguments.length&&(t=X.newId()),B("doc","path",t),e instanceof tO){let n=P.fromString(t,...r);return $(n),new tx(e,null,new M(n))}{if(!(e instanceof tx)&&!(e instanceof tU))throw new E(w.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");let n=e._path.child(P.fromString(t,...r));return $(n),new tx(e.firestore,e instanceof tU?e.converter:null,new M(n))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e){if("L"===e.limitType&&0===e.explicitOrderBy.length)throw new E(w.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}((e=j(e,tP))._query);let t=tC(e.firestore),r=new rA(e.firestore);return tD(t,e._query).then(t=>{let n=t.map(t=>new ra(e.firestore,r,t.key,t,e.converter));return"L"===e._query.limitType&&n.reverse(),new ro(e,n)})}function rD(e,t,r,...n){let i;let s=tX((e=j(e,tx)).firestore);return i="string"==typeof(t=(0,l.m9)(t))||t instanceof tq?function(e,t,r,n,i,s){let a=e.createContext(1,t,r),o=[re(t,n,r)],u=[i];if(s.length%2!=0)throw new E(w.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<s.length;e+=2)o.push(re(t,s[e])),u.push(s[e+1]);let c=[],h=eJ.empty();for(let e=o.length-1;e>=0;--e)if(!ri(c,o[e])){let t=o[e],r=u[e];r=(0,l.m9)(r);let n=a.childContextForFieldPath(t);if(r instanceof tZ)c.push(t);else{let e=t5(r,n);null!=e&&(c.push(t),h.set(t,e))}}return new tW(h,new eQ(c),a.fieldTransforms)}(s,"updateDoc",e._key,t,r,n):function(e,t,r,n){let i=e.createContext(1,t,r);t7("Data must be an object, but it was:",i,n);let s=[],a=eJ.empty();return er(n,(e,n)=>{let o=rr(t,e,r);n=(0,l.m9)(n);let u=i.childContextForFieldPath(o);if(n instanceof tZ)s.push(o);else{let e=t5(n,u);null!=e&&(s.push(o),a.set(o,e))}}),new tW(a,new eQ(s),i.fieldTransforms)}(s,"updateDoc",e._key,t),tN(tC(e.firestore),[i.toMutation(e._key,ti.exists(!0))])}function rV(e){return tN(tC((e=j(e,tx)).firestore),[new tl(e._key,ti.none())])}function rk(e,t){var r,n,i;let s=tB(e=j(e,tU)),a=(r=e.converter,n=t,r?r.toFirestore(n):n),o=function(e,t,r,n,i,s={}){let a,o;let l=e.createContext(s.merge||s.mergeFields?2:0,t,r,i);t7("Data must be an object, but it was:",l,n);let u=t9(n,l);if(s.merge)a=new eQ(l.fieldMask),o=l.fieldTransforms;else if(s.mergeFields){let e=[];for(let n of s.mergeFields){let i=re(t,n,r);if(!l.contains(i))throw new E(w.INVALID_ARGUMENT,`Field '${i}' is specified in your field mask but missing from your input data.`);ri(e,i)||e.push(i)}a=new eQ(e),o=l.fieldTransforms.filter(e=>a.covers(e.field))}else a=null,o=l.fieldTransforms;return new tK(new eJ(u),a,o)}(tX(e.firestore),"addDoc",s._key,a,null!==s.converter,{});return tN(tC(e.firestore),[o.toMutation(s._key,ti.exists(!1))]).then(()=>s)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
